Public Class SoftwareTriggerFm
    REM :Camera device
    Dim m_dev As ThridLibray.IDevice

    REM :Init form
    Private Sub SoftwareTriggerFm_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
    ...
    Private Sub OnImageGrabbed(ByVal sender As System.Object, ByVal e As ThridLibray.GrabbedEventArgs)
        ...
        If pbImage.InvokeRequired Then
            Try
                pbImage.BeginInvoke(New MethodInvoker(Sub()
                                                          REM :Init graphics
    ...
    Private Sub btnOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpen.Click
        Try
            ...
            If DeviceList.Count > 0 Then
                ...
                REM :Open trigger mode
                If Not m_dev.TriggerSet.Open(ThridLibray.TriggerSourceEnum.Software) Then
                    MessageBox.Show("Open Trigger Failed")
                    Return
                End If
    ...
    Private Sub btnTrigger_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTrigger.Click
        Try
            If Not m_dev Is Nothing Then
                REM :Execute Trigger
                If Not m_dev.ExecuteSoftwareTrigger() Then
                    MessageBox.Show("Execute Trigger Failed")
                End If
            End If
        Catch ex As Exception
            Throw New Exception(ex.Message, ex)
