// MultiCamerasTool.cpp : 定义应用程序的类行为。
// MultiCamerasTool.cpp :defining the class behavior of an application
...
BEGIN_MESSAGE_MAP(CMultiCamerasToolApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMultiCamerasToolApp 构造
// CMultiCamerasToolApp constructor
CMultiCamerasToolApp::CMultiCamerasToolApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的一个 CMultiCamerasToolApp 对象
// the only CMultiCamerasToolApp object
CMultiCamerasToolApp theApp;


// CMultiCamerasToolApp 初始化
// CMultiCamerasToolApp initialization
BOOL CMultiCamerasToolApp::InitInstance()
{
