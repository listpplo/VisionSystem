...
int main()
{
	...
	do
	{
		...
		IMV_FG_EGrabStrategy grabStrategy = IMV_FG_EGrabStrategy::IMV_FG_GRAB_STRARTEGY_UNDEFINED;

		printf("Start grabbing.\r\n");
		// 开始拉流 
		// Start grabbing
		nRet = IMV_FG_StartGrabbingEx(ifHandle, 0, grabStrategy);
		if (IMV_FG_OK != nRet)
		{
