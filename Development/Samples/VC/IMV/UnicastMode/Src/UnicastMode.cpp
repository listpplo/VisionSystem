...
/// \~chinese
/// \brief 单播模式发现设备示例
/// \example UnicastMode.cpp
/// \~english
/// \brief Discover camera by unicast mode
/// \example UnicastMode.cpp
...
int main()
{
	...
	// 单播模式发现设备 
	// discover camera by unicast mode
	IMV_DeviceList deviceInfoList;
	ret = IMV_EnumDevicesByUnicast(&deviceInfoList, (const char*)"10.33.41.252");
	if (IMV_OK != ret)
	{
