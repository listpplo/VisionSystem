    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            do
            {
                ...
                // 重置流统计信息
                // Reset stream statistics infomation
                res = card.IMV_FG_ResetStatisticsInfo();
                if (res != IMVFGDefine.IMV_FG_OK)
                {
                    Console.WriteLine("Reset statistics info failed! errorCode:[{0}]", res);
                    break;
                }
                ...
                // 获取流统计信息
                // Get stream statistics infomation
                IMVFGDefine.IMV_FG_StreamStatisticsInfo streamStatsInfo = new IMVFGDefine.IMV_FG_StreamStatisticsInfo();
                res = card.IMV_FG_GetStatisticsInfo(ref streamStatsInfo);
                if (res != IMVFGDefine.IMV_FG_OK)
                {
                    Console.WriteLine("Get statistics info failed! errorCode:[{0}]", res);
                    break;
                }
                ...
                displayStreamStatisticsInfo(streamStatsInfo);
            } while (false);
        ...
        private static void displayStreamStatisticsInfo(IMVFGDefine.IMV_FG_StreamStatisticsInfo streamStatsInfo)
        {
            if (streamStatsInfo.nDeviceType == IMVFGDefine.IMV_FG_EDeviceType.IMV_FG_TYPE_U3V_DEVICE)
            {

                Console.WriteLine("bangwidth : " + streamStatsInfo.u3vStatisticsInfo.bandwidth);
                Console.WriteLine("fps : " + streamStatsInfo.u3vStatisticsInfo.fps);
                Console.WriteLine("imageError : " + streamStatsInfo.u3vStatisticsInfo.imageError);
                Console.WriteLine("imageReceived : " + streamStatsInfo.u3vStatisticsInfo.imageReceived);
                Console.WriteLine("lostPacketBlock : " + streamStatsInfo.u3vStatisticsInfo.lostPacketBlock);
            }
            else if (streamStatsInfo.nDeviceType == IMVFGDefine.IMV_FG_EDeviceType.IMV_FG_TYPE_CL_DEVICE)
            {
                Console.WriteLine("bangwidth : " + streamStatsInfo.clStatisticsInfo.bandwidth);
                Console.WriteLine("fps : " + streamStatsInfo.clStatisticsInfo.fps);
                Console.WriteLine("imageError : " + streamStatsInfo.clStatisticsInfo.imageError);
                Console.WriteLine("imageReceived : " + streamStatsInfo.clStatisticsInfo.imageReceived);
                Console.WriteLine("lostPacketBlock : " + streamStatsInfo.clStatisticsInfo.lostPacketBlock);
            }
            else if (streamStatsInfo.nDeviceType == IMVFGDefine.IMV_FG_EDeviceType.IMV_FG_TYPE_GIGE_DEVICE)
            {
                Console.WriteLine("bangwidth : " + streamStatsInfo.gigeStatisticsInfo.bandwidth);
                Console.WriteLine("fps : " + streamStatsInfo.gigeStatisticsInfo.fps);
                Console.WriteLine("imageError : " + streamStatsInfo.gigeStatisticsInfo.imageError);
                Console.WriteLine("imageReceived : " + streamStatsInfo.gigeStatisticsInfo.imageReceived);
                Console.WriteLine("lostPacketBlock : " + streamStatsInfo.gigeStatisticsInfo.lostPacketBlock);
            }
