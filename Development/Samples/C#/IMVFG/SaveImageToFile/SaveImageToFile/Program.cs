...
namespace SaveImageToFile
{
    internal class Program
    {
        ...
        private static void imageSave(ref IMVFGDefine.IMV_FG_Frame frame, int format)
        {
            lock (lockobj)
            {
                IMVFGDefine.IMV_FG_SaveImageToFileParam stSaveImageToFileParam = new IMVFGDefine.IMV_FG_SaveImageToFileParam();
                stSaveImageToFileParam.eImageType = (IMVFGDefine.IMV_FG_ESaveFileType)format;
                ...
                stSaveImageToFileParam.eBayerDemosaic = IMVFGDefine.IMV_FG_EBayerDemosaic.IMV_FG_DEMOSAIC_EDGE_SENSING;
                if (stSaveImageToFileParam.eImageType == IMVFGDefine.IMV_FG_ESaveFileType.IMV_FG_TYPE_SAVE_BMP)
                {
                ...
                else if (stSaveImageToFileParam.eImageType == IMVFGDefine.IMV_FG_ESaveFileType.IMV_FG_TYPE_SAVE_JPEG)
                {
                ...
                else if (stSaveImageToFileParam.eImageType == IMVFGDefine.IMV_FG_ESaveFileType.IMV_FG_TYPE_SAVE_PNG)
                {
                ...
                else if (stSaveImageToFileParam.eImageType == IMVFGDefine.IMV_FG_ESaveFileType.IMV_FG_TYPE_SAVE_TIFF)
                {
                    stSaveImageToFileParam.pImagePath = "Image_w" + stSaveImageToFileParam.nWidth.ToString() + "_h" +
                                                        stSaveImageToFileParam.nHeight.ToString() + "_blockId" +
                ...
                int nRet = card.IMV_FG_SaveImageToFile(ref stSaveImageToFileParam);
                if (nRet != IMVFGDefine.IMV_FG_OK)
                {
