    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            do
            {
                ...
                res = cam.IMV_ResetStatisticsInfo();
                if (res != IMVDefine.IMV_OK)
                {
                ...
                IMVDefine.IMV_StreamStatisticsInfo streamStatsInfo = new IMVDefine.IMV_StreamStatisticsInfo();
                res = cam.IMV_GetStatisticsInfo(ref streamStatsInfo);
                if (res != IMVDefine.IMV_OK)
                {
        ...
        private static void displayStreamStatisticsInfo(IMVDefine.IMV_StreamStatisticsInfo streamStatsInfo)
        {
            if (streamStatsInfo.nCameraType == IMVDefine.IMV_ECameraType.typeU3vCamera)
            {
                Console.WriteLine("bandwidth : " + streamStatsInfo.u3vStatisticsInfo.bandwidth);
            ...
            else if (streamStatsInfo.nCameraType == IMVDefine.IMV_ECameraType.typeGigeCamera)
            {
                Console.WriteLine("bandwidth : " + streamStatsInfo.gigeStatisticsInfo.bandwidth);
